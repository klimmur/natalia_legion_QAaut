...
store input (my prompt) in block2/DS-4 folder and name it prompt_input.md
store your results in .md file in block2/DS-4 folder and name it agent_output.md
